...
Spiegelt Inventar (Schlösser/Gateways) und holt neue Zutrittslogs aus der TTLock-Cloud.
Read-only gegenüber den Schlössern; schreibt nur in die eigene DB. Idempotent (Dedupe
über recordId), daher gefahrlos wiederholbar.
