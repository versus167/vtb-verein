...
class VereinsDB:
    ...
    def __init__(self, database_url: str, upload_path: str = 'uploads/'):
        ...
        self._schliessanlage_einstellungen_repo = SchliessanlageEinstellungenRepository(self.conn)
    ...
    @property
    def schliessanlage_einstellungen(self) -> SchliessanlageEinstellungenRepository:
        return self._schliessanlage_einstellungen_repo
    ...
    # --- Kalender-Abos (#153) ---
    @property
    def kalender_abos(self) -> KalenderAboRepository:
        return self._kalender_abo_repo
