...
PRUNE_REGISTRY: tuple[PruneEntity, ...] = (
    ...
    # --- Teamtresor/Clubdeckel (#98, Blatt → Wurzel, vor mannschaft/mitglied) ---
    PruneEntity("clubdeckel_buchung", "Teamtresor-Buchungen", "clubdeckel_buchung",
                history_table="clubdeckel_buchung_history"),
    PruneEntity("clubdeckel_artikel", "Teamtresor-Artikel", "clubdeckel_artikel",
                history_table="clubdeckel_artikel_history",
                children=(ChildRef("clubdeckel_buchung", "artikel_id"),)),
    PruneEntity("clubdeckel_gruppe", "Teamtresor-Artikelgruppen", "clubdeckel_gruppe",
                history_table="clubdeckel_gruppe_history",
                children=(ChildRef("clubdeckel_artikel", "gruppe_id"),)),
    PruneEntity("clubdeckel_berechtigung", "Teamtresor-Warte", "clubdeckel_berechtigung",
                history_table="clubdeckel_berechtigung_history"),
    PruneEntity("clubdeckel_beitrag_befreiung", "Teamtresor-Beitragsbefreiungen",
                "clubdeckel_beitrag_befreiung",
                history_table="clubdeckel_beitrag_befreiung_history"),
    PruneEntity("clubdeckel", "Teamtresore", "clubdeckel",
